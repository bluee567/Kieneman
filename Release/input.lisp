...
(defvar *c1-config*
  (list
   ...
   :a2 (get-ji 1 0) "Button 2"
   :defense (get-ji 3 0) "NUM9"
   :dodge (get-ji 7 0) "Button 8"
   :cancel (get-ji 2 0) "Button 3"
...
(defvar *k2-config*
  (list
   :a1 (get-kbi KC_NUMPAD4) "J"
   :a2 (get-kbi KC_NUMPAD5) "K"
   :defense (get-kbi KC_NUMPAD6) "L"
   :dodge (get-kbi KC_NUMPAD8) "I"
   :cancel (get-kbi KC_NUMPAD9) "O"
