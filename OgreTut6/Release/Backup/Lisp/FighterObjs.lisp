...
(defmethod initialize-instance :after ((fighter fighter) &key)
  ...
  ;; (with-accessors ((display display)) fighter
;;     (setf display (make-hit-rectangle (x fighter) (median-y fighter) (width fighter) (height fighter) "blue" *mgr*)))
  )

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; Movement

(defgeneric (setf x) (value fighter))
...
(defgeneric (setf y) (value fighter))
